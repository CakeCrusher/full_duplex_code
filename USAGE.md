...
- **Milestones (default):** only decisions you must make, discoveries that substantially change the plan, and completion of the whole task. Explain one useful outcome in one or two complete sentences, then stop.
